...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.urlTobase64 = exports.ajax = exports.setTime = exports.hideLoading = exports.showLoading = exports.showTips = void 0;var ohref = '';
...
var ajax = {
  upload: ohref + '/upload',
  login: ohref + '/login' };exports.ajax = ajax;



var urlTobase64 = function urlTobase64(url) {
  console.log(url);
  wx.request({
    url: url,
